...
<body style="background: #f6f5f7;">
 ...
 <div class="container-fluid ">
		...
		<div class="col-sm-4  shadow-lg" style="height: 90vh;border-top-right-radius:10px;
 			...
 			<div class="col-sm-3 shadow-lg d-flex align-items-center text-white" id="idDiv" style="height: 10vh;  border-top-left-radius:10px;
            ...
            <!--     <div class="row mt-12 justify-content-center">
                    <div class="col-sm-12" style="width: 30vh;">
                        <p class="mt-3" style="text-align: center;">Enter your personal Choice Car</p>
                    </div>
                </div>
			-->
            ...
            <div>
            <h1>Enter Your 	Choice Brand Name</h1>
            </div>
<spr:form action="userchoice_add.htm" method="GET" commandName="newcar" >
